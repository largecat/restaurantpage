...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"homePage\": () => (/* binding */ homePage)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module '../images/ship.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module '../images/thomas-marban-EHK-EH1SRzQ-unsplash.jpg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\n\n\nconst homePage = function() {\n\tconst content = document.querySelector('#content');\n\n\tlet header = () => {\n\t\tconst header = document.createElement('header');\n\n\t\tconst logo = new Image();\n\t\tlogo.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../images/ship.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\t\tlogo.id = 'logo';\n\t\theader.append(logo);\n\n\t\tconst title = document.createElement('h1');\n\t\ttitle.textContent = 'The Pearl';\n\t\theader.append(title);\n\t\tcontent.append(header);\n\t};\n\theader();\n\n\tlet main = () => {\n\t\tconst main = document.createElement('main');\n\t\tcontent.append(main);\n\n\t\tconst img = new Image();\n\t\timg.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../images/thomas-marban-EHK-EH1SRzQ-unsplash.jpg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\t\tmain.append(img);\n\n\t\timg.classList.add('mainImg');\n\n\t\tconst description = document.createElement('div');\n\t\tdescription.classList.add('description');\n\t\tmain.append(description);\n\t\tconst blurb = document.createElement('p');\n\t\tblurb.textContent =\n\t\t\t'Pirate Jack Lingo opened The Pearl in 1784 as a secret club for pirates. Today they serve fresh sushi and japanese food for some reason. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima suscipit non tempore, rerum cum labore accusamus ea excepturi dolore fugit rem? At saepe enim esse, iure vitae architecto explicabo eos.';\n\n\t\tdescription.append(blurb);\n\t\tconst quoter = document.createElement('span');\n\t\tquoter.classList.add('writer');\n\t\tquoter.textContent = '- Owner';\n\t\tblurb.append(quoter);\n\t};\n\tmain();\n\n\treturn {\n\t\theader,\n\t\tmain\n\t};\n};\n\n// content.appendChild(homePage());\n\n\n\n\n//# sourceURL=webpack://restaurantpage/./src/js/homePage.js?");
